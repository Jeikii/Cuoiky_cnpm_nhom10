...
<?php 
  ...
  // join bảng khoa với bảng, mà trong bảng đó thì bảng bacsi với bảng chucvu join với nhau để tìm ra chức vụ của người đó, xong sau đó sẽ join với khóa id của bảng khoa với khóa khoa trong bảng bacsi để đưa ra khoa mà người đó đang làm
