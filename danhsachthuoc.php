...
<?php 
  ...
  $query_show = mysqli_query($conn,"Select tb.id, npp.tenthuoc as 'tenthuoc', tb.soluongton, tb.lieudung,tb.lieudungtoida, tb.thoigianuong, npp.tencongty as 'tencongty', tb.gia from thuocban tb right join nhaphanphoi npp on tb.nhaphanphoi = npp.id");
  ...
  $query_show = mysqli_query($conn,"Select tb.id, npp.tenthuoc as 'tenthuoc', tb.soluongton,tb.lieudung,tb.lieudungtoida, tb.thoigianuong, npp.tencongty as 'tencongty', tb.gia from thuocban tb right join nhaphanphoi npp on tb.nhaphanphoi = npp.id order by id ASC limit $start,$limit");
  if (isset($_POST['search'])) {
    $search = $_POST['search'];
    $query_show = mysqli_query($conn,"Select tb.id, npp.tenthuoc as 'tenthuoc', tb.soluongton,tb.lieudung,tb.lieudungtoida, tb.thoigianuong, npp.tencongty as 'tencongty', tb.gia from thuocban tb right join nhaphanphoi npp on tb.nhaphanphoi = npp.id where npp.tenthuoc like '%$search%' or npp.tencongty like '%$search%' ");
  }
 ?>
