...
<?php 
  ...
  $id_benhnhan = $_GET['id'];
  // dùng câu lệnh Select để chọn ra tất cả các thông tin của người nhà và bệnh nhân thông qua 2 bảng cùng tên với điều kiện kết nối giữa chúng là bn.nguoinha = nh.id. Sau đó dùng vòng lặp foreach để duyệt qua từng dòng kết quả của truy vấn, mỗi dòng dc lưu trong mảng "$query_select_bn" và được truy xuất qua biến "$bn_nh".
