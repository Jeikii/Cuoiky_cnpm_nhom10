<div class="row">
  ...
  <!-- <div class="col-lg-4">
    <div class="panel card-default widget widget-calendar">
      ...
      <div class="card-body" style="height: 340px;"><li>Giáo Viên hướng dẫn: <span style="font-weight: bold;"> Vũ Thị Trà</span></li>
        <p>--------------------------------------------------------</p>
        <div style="width: 35%; float: left;"><li>Thành viên:</li></div>
        <div style="width: 65%; float: left; font-weight: bold "><p>Nhóm 10</p></div>
      </div>
    </div>
  </div> -->
  <!-- /.col-lg-8 -->
  <!-- <div class="col-lg-8">
    <div class="panel card-default widget widget-worldmap">
      <div class="card-heading">
        <h3 class="card-title">Địa chỉ bệnh viện</h3>
      </div>
      <div class="card-body">
        <div class="row">
          <div id="map" style="width:450px;height:315px;">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.770407597048!2d108.1646011440652!3d16.06880486012947!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ac7a76c79c0f%3A0xa37d3ed4526ea954!2zQuG7h25oIHZp4buHbiBC4bqhY2ggTWFp!5e0!3m2!1svi!2s!4v1539239438596" width="630" height="315" frameborder="0" style="border:0" allowfullscreen></iframe>
          </div>
        </div>
			</div>
		</div>
...
<footer class="site-footer text-center">
  <p>&copy; 2023 Nhóm 10 </p>
  <ul class="list-inline">
    <li class="list-inline-item"><a href="#">21CNTT4</a></li>
    <li class="list-inline-item"><a href="#">Công nghệ phần mềm</a></li>
    <li class="list-inline-item"><a href="#">Đại Học Sư Phạm Đà Nẵng</a></li>
  </ul>
</footer>
          <!-- </div>
        </div>
